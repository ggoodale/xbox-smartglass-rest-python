...
docker-build-arm:
	docker build . -f Dockerfile.arm32v6 -t xbox-smartglass-rest-python:develop-arm
...
docker-run-cross:
	docker run -e XBOX_IP=192.168.2.5 -p 5557:5557 -e XBOX_IP=192.168.2.5 xbox-smartglass-rest-python:cross-platform
